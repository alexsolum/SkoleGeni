...
- [ ] **INFRA-01**: Optimizer container is deployed to Google Cloud Run and accessible via a public HTTPS endpoint
- [ ] **INFRA-02**: Optimizer container image is stored in Google Artifact Registry
